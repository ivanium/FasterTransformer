...
#include "src/fastertransformer/models/manifold-llama/LlamaDecoderLayerWeight.h"
...
LlamaDecoderLayerWeight<T>::~LlamaDecoderLayerWeight()
{
    if (is_maintain_buffer == true) {
        ...
        if (int8_mode_ != 0) {
            ...
            //  作一下标记  intermediate_weight => gate_proj;  intermediate_weight2 => up_proj; output_weight =>
            //  down_proj.
